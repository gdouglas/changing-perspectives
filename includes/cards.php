...
$cards = '<section class="cards-wrapper no-active" aria-label="Videos about European sailing technologies">
<div class="offScreen">
    <p>
    ...
    <div id="card3" class="card">
        <div class="content">
            ...
            <div class="back">
                ...
                <div class="responsive-wrapper">
                    <iframe id="video3" class="vimeo" src="https://player.vimeo.com/video/285512274?color=ADC70C&title=0&byline=0&portrait=0&speed=1&playsinline=true" width="640" height="274" allow="autoplay; fullscreen; gyroscope; accelerometer" allowfullscreen></iframe>
                    <noscript>
