    ...
    <main id="main" role="main" tabindex="-1">
        <div class="home-intro">
            ...
            <div class="text-left">
                ...
                <h2 class="text-left margin-bottom-none">You will learn:</h2>
                <ul class="margin-top-none">
                    ...
                    <li>What were the challenges experienced by Vancouver and his crew?</li>
                    <li>What it was like for Indigenous and European people to meet for the first time?</li>
                    <li>What technologies did the Europeans need to get them here?</li>
                    <li>What are the legacies of Vancouver&rsquo;s journey here for people&rsquo;s lives today?</li>
                </ul>
