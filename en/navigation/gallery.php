<section id="gallery" class="gallery">
    ...
    <ul>
        <li>
            <a href="#sextant" class="open">
                <img src="/images/navigation/sextant.jpg" alt="A brass sextant. It is triangular with an arc on the bottom.">
            </a>
        </li>
        <li>
            <a href="#telescope" class="open">
                <img src="/images/navigation/telescope.jpg" alt="A telescope with a brass tip holding the lens and eyepiece. The body is shiny weathered leather.">
            </a>
        </li>
        <li>
            <a href="#chronometer" class="open">
                <img src="/images/navigation/chronometer.jpg" alt="A wooden box opened with a clock like mechanism inside of it.">
            </a>
        </li>
    </ul>
    ...
    <div id="telescope" class="description">
        ...
        <figure>
            <img src="/images/navigation/telescope.jpg" alt="A telescope with a brass tip holding the lens and eyepiece. The body is shiny weathered leather." load="lazy">
            <figcaption>
