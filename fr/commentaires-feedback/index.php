...
<body>
    ...
    <main id="main" role="main" tabindex="-1">
        ...
        <p class="narrow-container centered-margin pad-bottom">Vos commentaires seront acheminés au Vancouver Maritime Museum et au Musée canadien de l’histoire, qui a la responsabilité globale de Musées numériques Canada (MNC), à des fins de recherche sur le public. Veuillez consulter la <a href="https://www.museesnumeriques.ca/avis/" target="_blank" rel="noopener">Politique de MNC sur la protection des renseignements personnels</a> pour de plus amples détails.</p>
