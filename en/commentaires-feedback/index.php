    ...
    <main cid="main">
        ...
        <form class="contact-form" name="contactform" method="post" action="send.php" onsubmit="return validate.check(this)">
            <fieldset>
                ...
                <label class="required">Name:<span class="required_star">*</span> <br> <input id="email_sender_name" name="email_sender_name" type="text" placeholder="Firstname, lastname" class="required" required></label>
                <label class="required">Email:<span class="required_star">*</span> <br> <input id="email_sender_email" name="email_sender_email" type="email" class="required" required placeholder="example@email.com"></label>
