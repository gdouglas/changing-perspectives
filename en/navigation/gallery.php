<section id="gallery" class="gallery">
    ...
    <div id="sextant" class="description">
        ...
        <figure>
            <img src="/images/navigation/sextant.jpg" alt="A brass sextant. It is triangular with an arc on the bottom." loading="lazy">
            <figcaption>
    ...
    <div id="chronometer" class="description">
        ...
        <figure>
            <img src="/images/navigation/chronometer.jpg" alt="A wooden box opened with a clock like mechanism inside of it." loading="lazy">
            <figcaption>
    ...
    <div id="telescope" class="description">
        ...
        <figure>
            <img src="/images/navigation/telescope.jpg" alt="A telescope with a brass tip holding the lens and eyepiece. The body is shiny weathered leather." loading="lazy">
            <figcaption>
